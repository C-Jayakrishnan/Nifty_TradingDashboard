...
export default function WelcomePage({ stats }) {
  ...
  return (
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.55fr) minmax(320px, 0.95fr)', gap: 16, alignItems: 'stretch' }}>
        <div className="card" style={{ padding: '22px 24px', minHeight: 430 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 360px) 1fr', gap: 20, alignItems: 'center' }}>
      ...
      {results && (
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) minmax(320px, 1.1fr)', gap: 16 }}>
          <div className="card fade-in" style={{ padding: '20px 22px' }}>
      ...
      {results && gapRow && (
        <div className="card fade-in" style={{ padding: '20px 22px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(260px, 0.8fr) 1fr', gap: 18, alignItems: 'center' }}>
