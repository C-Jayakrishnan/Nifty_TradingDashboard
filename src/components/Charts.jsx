...
export function Gauge({ value, label, color, size = 120, subtitle, actionLabel }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, width: '100%', maxWidth: size }}>
      <div style={{ position: 'relative', width: '100%', maxWidth: size, aspectRatio: '100 / 86', filter: 'drop-shadow(0 18px 34px rgba(0,0,0,0.3))' }}>
        <div style={{
          position: 'absolute',
          inset: '12% 10% 22%',
          borderRadius: '50%',
        ...
        <svg viewBox="0 0 100 86" width="100%" height="100%" style={{ overflow: 'visible', position: 'relative', display: 'block' }}>
