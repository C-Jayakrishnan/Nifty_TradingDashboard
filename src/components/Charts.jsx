...
export function Gauge({ value, label, color, size = 120, subtitle, actionLabel }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
      <div style={{ position: 'relative', width: size, filter: 'drop-shadow(0 18px 34px rgba(0,0,0,0.3))' }}>
        <div style={{
          position: 'absolute',
          inset: '12% 10% 22%',
          borderRadius: '50%',
        ...
        <svg viewBox="0 0 100 70" width={size} height={size * 0.72} style={{ overflow: 'visible', position: 'relative' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      <div style={{ position: 'relative', width: size, height: size }}>
        ...
        <svg viewBox="0 0 140 140" width={size} height={size} style={{ position: 'relative' }}>
